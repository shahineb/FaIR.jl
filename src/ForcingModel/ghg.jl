...
struct Leach21
    ...
    function Leach21(f₁ᶜᴼ²::Real, f₃ᶜᴼ²::Real, f₃ᶜᴴ⁴::Real, f₃ᴺ²ᴼ::Real)
        new(f₁ᶜᴼ², f₃ᶜᴼ², f₃ᶜᴴ⁴, f₃ᴺ²ᴼ)
    end
    ...
    function Leach21(path::String, species::Vector{String})
        ...
        new(params.f[index.CO2, 1], params.f[index.CO2, 3], params.f[index.CH4, 3], params.f[index.N2O, 3])
    end
end
